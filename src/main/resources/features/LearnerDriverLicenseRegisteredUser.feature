Feature: Learner Driver License for Registered User
  ...
  Scenario: 
    As a logged in citizen I can submit the Learner Driver License service request by filling up valid data and using custom address for shipping
    ...
    And User will fills the Health Details form with valid data
      ...
      | No       | No                                | No                                           | No           |
    And User "uncheck" the primary address in shipping address page  for Learner Driver Licence Service
  ...
  Scenario: 
    As a logged in citizen I can submit the Learner Driver License service request by filling up valid data and using primary address for shipping
  ...
  Scenario: 
    As a citizen I can view the error message on Health Details section by filling up invalid data
  ...
  Scenario: 
    As a citizen I can view the error message on License Details section by filling up invalid data

    Then User will fills the Applicant Details form with valid data
      | Title | FirstName  | LastName | DOB        | Gender | identificationProof     |
      | Mr    | Automation | Citizen  | 1992-02-02 | Female | IdentificationProof.PNG |
    When User clicks on next button in "License Details" yformPage
    Then User will get an error dialog message with error message "There are validation errors. Please retry once all fields have been properly filled-out."
