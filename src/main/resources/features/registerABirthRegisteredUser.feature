Feature: Regsiter A Birth for Registered User
  ...
  Scenario: As a citizen I can submit the Register a Birth service request by selecting bundle option other than "None" and using custom address for shipping
    ...
    And User fills the Parent2 Details form with valid data
      | Title | FirstName | LastName | Gender | DOB        | PlaceOfBirth | RelationshipToChild | Country        | Address1           | City    | PostalCode | PhoneNumber | EmailAddress                          | Parent2IsUnknown |
      | Ms    | Jane      | Citizen  | Female | 1986-02-02 | Rosebud      | Mother              | United Kingdom | 230 Primary Street | Rosebud |       1000 |  0011234567 | automationtestuser@stateofrosebud.com | False            |
    And User "uncheck" the primary address in shipping address page for register a birth
  ...
  Scenario: As a citizen I can submit the Register a Birth service request by selecting bundle option other than "None" and using primary address for shipping
    Then User selects "two birth certificate" option from Registration Options page
    And User fills the Child Details form with valid data
      | FirstName | LastName | UnderstandThatAsParents | DOB        | BirthWeight | Gender | Country        | Address1           | City    | PostalCode |
      | Charles   | Citizen  | true                    | 1992-02-02 |        2000 | Female | United Kingdom | 230 Primary Street | Rosebud |       2234 |
  ...
  Scenario: As a citizen I can veiw the error message on Registration Options section
