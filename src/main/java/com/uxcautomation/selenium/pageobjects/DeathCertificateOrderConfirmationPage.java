...
public class DeathCertificateOrderConfirmationPage extends OrderConfirmationPage {
	...
	@FindBy(how = How.XPATH, using = "//h1[contains(text(),'Confirmation - Apply for Death Certificate')]")
	WebElement confirmationTitle;

	public DeathCertificateOrderConfirmationPage(WebDriver driver) {
		super(driver);
		// TODO Auto-generated constructor stub
	}
	
	public void verifyDeathCertificateConfirmationPageIsDisplayed(List<Map<String,String>> deathCertificatePageData) {
		
		log.info("Death Certificate confirmation page");
		...
		try {
			Assert.assertEquals("Confirmation - Apply for Death Certificate", confirmationTitle.getText());
