...
public class CheckoutPoolBuildingPermitReviewPage extends CheckoutFinalReviewPage {
	...
	public CheckoutPoolBuildingPermitReviewPage(WebDriver driver) {
		super(driver);
	}

	public void verifyReviewPage(List<Map<String, String>> pageData) {
		log.info("Verifying review page for Pool Building Permit");
		try {
