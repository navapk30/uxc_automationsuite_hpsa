 ...
 *
 */
public class MarriageCertificateOrderConfirmationPage extends OrderConfirmationPage {


	public MarriageCertificateOrderConfirmationPage(WebDriver driver) {
		super(driver);
	}
	...
	public void verifyInformationOnConfirmationPageDisplayed() {
		...
		try {
			Assert.assertEquals("Confirmation - Apply for Marriage Certificate", summaryTitle.getText());
